# -*- coding: utf-8 -*-
"""
RSNA 增强图像生成：对加噪切片施加 9 种增强（filter）

路径为 enhanced_tests/rsna/{noise}/{method}/...
...
用法:
    python 06_generate_enhanced_images_rsna.py
    python 06_generate_enhanced_images_rsna.py --noises unknown_mixed --limit 100
"""
import argparse
import sys
...
from rsna_commons import (FILTER_NAMES, NOISE_NAMES, NOISY_ROOT, apply_filter,
