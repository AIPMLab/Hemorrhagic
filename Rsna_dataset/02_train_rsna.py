# -*- coding: utf-8 -*-
"""
RSNA 子集二分类训练（Normal / Hemorrhagic）

与 CQ500 的 02_train_cq500.py 同构，只在数据集相关处不同：
  - 用 rsna_commons（索引 rsna_slices_index.csv，患者键为 patient_id）
  - 权重存为 models/*_rsna_best.pth
...
用法:
    python 02_train_rsna.py
    python 02_train_rsna.py --models resnet50
    python 02_train_rsna.py --epochs 1 --limit 600      # 冒烟测试
"""
import argparse
import random
import sys
...
from rsna_commons import (CLASSES, MODEL_DIR, NUM_CLASSES, RESULT_ROOT,
...
def main():
    ...
    for model_name in models_to_train:
        ...
        best_f1, best_path = -1.0, MODEL_DIR / f"{model_name}_rsna_best.pth"
        ...
        rows.append({"dataset": "rsna", "model": model_name, "best_patient_f1": best_f1,
                     "epochs": args.epochs, "batch_size": args.batch_size,
                     "num_workers": args.num_workers, "seed": args.seed,
                     "label_column": args.label_column, "weight": str(best_path)})

    out = RESULT_ROOT / "rsna_train_summary.csv"
